...
Each problem remains incompletely solved, and the interfaces between problems — how licensing constrains firing, how timing determines inheritance, how fidelity varies with timing — represent exciting frontiers for the future of research. The convergence of reconstituted biochemistry, cryo-EM structural biology, single-cell genomics, and quantitative modeling positions the field to achieve a fully integrated, predictive understanding of how cells duplicate their chromosomes.
