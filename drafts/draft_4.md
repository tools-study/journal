...
**Keywords:** genetic engineering, self-amplifying RNA, bridge recombination, virus-like particles, contractile injection systems, erythrocyte delivery, extracellular vesicles, CAR-macrophage, mitochondrial editing, intercellular transfer, genome editing, gene therapy
...
**2024--present: The integration challenge.** We are now at the inflection point where the component technologies for whole-body editing exist but have not been integrated. This work represents the first systematic analysis of how these components can be combined into a coherent strategy for the trillions-of-cells problem.
