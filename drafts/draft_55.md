...
We introduce six frameworks that collectively provide the calibration, allocation, and falsifiability backbone of ISA. Each is designed to be implementable on a laptop and interpretable by a reviewer; each is distinct from the F1–F402 catalog of our prior work.
