...
First, a recently discovered factor, UHRF2 — the paralog of the DNMT1 cofactor UHRF1 — mediates resistance to DNA methylation reprogramming specifically at evolutionarily young retrotransposons in PGCs (Dahlet et al., 2025). PGCs from Uhrf2 knockout mice show loss of retrotransposon DNA methylation while somatic cell methylation remains unaffected (Dahlet et al., 2025). Importantly, Uhrf2 deficiency leads to precocious demethylation and overexpression of meiotic genes in females, impaired oocyte development, and female-specific reduced fertility, as well as incomplete remethylation of retrotransposons during spermatogenesis (Dahlet et al., 2025). This finding reveals that selective methylation retention at TEs is not merely a passive resistance to demethylation but an active process requiring UHRF2-mediated recruitment of maintenance machinery.
...
| Meiotic demethylation | Epigenetic alterations | Passive (UHRF1 loss) + active (TET1/2) demethylation with UHRF2-mediated TE protection | Murase et al., 2024; Dahlet et al., 2025 |
| Histone-to-protamine | Epigenetic alterations | Chromatin compaction and selective histone retention | Gopinathan et al., 2025 |
