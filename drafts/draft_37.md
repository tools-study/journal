...
Whole-body rejuvenation requires simultaneously optimizing across $N$ tissues, each with its own dose-response and risk function. The optimization problem is:
